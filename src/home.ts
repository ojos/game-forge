 ...
 *
 * **ただし「いまの状態」の 1 文は #402 で直した。** #128 の時点の「試遊と公開の画面は
 * まだ準備中」が残っていたが、作品ページ（`/works/<game_id>`）では既に遊べて公開も
 * できる。**作った作品を開く手段が無いと読める文を、トップに置いたままにしない。**
 *
...
<p>登録がお済みの方は<a href="${GENERATE_PAGE_PATH}">ゲームを生成できます</a>。
   ...
   生成した作品は、まず下書きとして保存されます。作品ページで遊んで確かめてから公開できます。
   公開するまで、遊べる URL は作った本人にしか表示されません。</p>
