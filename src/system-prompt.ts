...
- 終わる条件は、指示された遊びに合うものを選びます。敵を全部倒す・決めた面をこえる・持ち時間が尽きる・残りが 0 になる、のどれでもかまいません。負けるまで延々と続くだけにはしません。
...
- 終わり方が、利用者の指示どおりになっている。指示に終わり方が書かれていなかったときだけ、遊びが終わる条件があり、終わったときに結果とやり直しが画面へ出る
