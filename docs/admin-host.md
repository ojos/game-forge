...
> **#394 で節の条件と文言が変わった**（下記「#394（問題なしとしたあとに通報が付いた作品）で
> 変わったこと」）。この節の見出し・札・条件の定数名は #367 の時点のもので、**いまの画面は
> 「問題なしとしたあとに通報が付いた作品」／「問題なしのあとに通報あり」／
> `REVIEW_REPORTED_AFTER_CLEAR_SQL`** である。
